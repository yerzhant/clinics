...
@section('header')
    Посещения
    <a class="w3-btn-floating w3-ripple w3-theme-l2 w3-hover-green header-down-btn-1"
        onclick="$('#modal').css('display', 'block')" title="Создать">
        <i class="fa fa-plus"></i>
    </a>

    <a href="/staff" class="w3-btn-floating w3-ripple w3-theme-l2 w3-hover-blue header-down-btn-2">
